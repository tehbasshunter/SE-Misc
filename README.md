This is a collection of pre-made templates for users to simulate various alert types as you would normally do with the overlay editor using a Streamdeck.
